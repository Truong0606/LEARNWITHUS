  ...
  return (
    <section className="py-16 bg-white md:py-20">
      <div className="px-4 mx-auto max-w-4xl sm:px-6 lg:px-8">
        <div className="relative p-8 md:p-12 rounded-3xl bg-gradient-to-br from-violet-600 via-fuchsia-600 to-pink-600 text-white text-center overflow-hidden">
          {/* Decorative elements */}
          ...
          <div className="relative">
            ...
            <div className="flex flex-col justify-center gap-4 sm:flex-row">
              <Link
                href="/register"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 text-violet-700 font-semibold transition-all bg-white rounded-xl hover:shadow-xl hover:-translate-y-0.5"
              >
                Đăng ký miễn phí
                <ArrowRight size={18} />
              </Link>
